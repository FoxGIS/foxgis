...
export default {
  ...
  data() {
      ...
      serviceShowMessage:[{
        title:"在线图集",
        description:"提供主题词、制图区域、制图年份等多种检索手段，对系统地图资源进行按需检索生成在线图集，提供图件在线预览或下载到本地，实现辅助决策用图资源共享。",
        image:"../../static/images/show/图集.jpg"
      },
      {
        title:"制图工程管理",
        description:"对制图工程数据进行统一管理，通过选择样式创建制图工程开启制图编辑，同时对已有制图工程进行查询、编辑及删除等操作，多种制图模板满足不同场景下的制图需求。",
